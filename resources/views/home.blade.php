...
@section('title') E-Waste | Home @endsection
...
<div style="background: linear-gradient(to bottom, #ffffff 30%, #dffbee 93%);">
    ...
    <div class="ser1">
        ...
        <div class="serhover">
            ...
            <h1>Save Plant</h1>
            <p>Support organizations that focus on reforestation efforts.</p>
        </div>
    </div>
    </div>
    <div class="text-center" style="position: relative; ">
...
The centre “aims to reduce the environmental impact of e-waste recycling activities in the country, ensure the transition of e-waste through proper and sound procedures, test a pricing or financing mechanism,” says Minister Kwaku Afriyie. The centre is a result of the Electronic and Hazardous Waste Control and Management Act passed in 2016 in Ghana. The initiative also aims to create at least 22,000 jobs for Ghana’s youth.";
    ...
    <div class="d-flex justify-content-center" style="margin-bottom:30px">
        <div class="mt-5 m-4 ">
            <h1 class="fw-bold">Educational Resources</h1>
        </div>
    </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="left-image">
                <img src="https://www.governmentnews.com.au/wp-content/uploads/2019/10/recycling-waste-resuse-sustainability-resized1.jpg?w=780&h=520&crop=1" class="img-fluid" alt="">
              </div>
            </div>
            <div class="col-md-6 align-self-center">
              <div class="right-content">
                <span>Why recycling is important..?</span>
