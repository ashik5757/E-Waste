...
<div class="main-banner header-text" id="top" style=" background: linear-gradient(to bottom, #dffbf0 30%, #ffffff 93%);">
    ...
    <div class="container home-con">
        <div class="half1">
            <h3 class="mt-5" style="color:rgb(47,155,92);font-size: 60px;">Blog Page Details</h3>
        </div>
    </div>
...
<div class="container">
    <div class="row justify-content-around" style="margin-bottom: 70px">
      <div class="col-4">
        <img src="/assets/images/demo.jpg"   class="img-fluid rounded-start" alt="..."  style="max-height: 300px;max-width: 300px">
      </div>
      <div class="col-6">
        <h1> <u>Card title</u></h1><br>
